...
# Check logs again for this example to verify if object 1 is being spilled again

# Check if after pulling object 1, if it stays there in remote node

# Check remote spill for 2 objects with same object id (expected that it will ignore request)

# Try to add a consumer here (should create same bug as in shuffle)

# If it works, try to create a mini shuffle